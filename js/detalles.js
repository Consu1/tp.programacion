window.addEventListener("load", function() {
    ...
    fetch("https://api.themoviedb.org/3/movie/" + id + "?api_key=cc55526ed6d9221ada36a41066b7c9ea&language=en-US")
    ...
    ///////TRAILER
    fetch("https://api.themoviedb.org/3/movie/" + id + "/videos?api_key=cc55526ed6d9221ada36a41066b7c9ea&language=en-US")
      .then(function(respuesta) {
        return respuesta.json();
      })
      .then(function(datos) {
    ...
    /////////////////// RECOMENDADOS
    fetch("https://api.themoviedb.org/3/movie/" + id + "/recommendations?api_key=cc55526ed6d9221ada36a41066b7c9ea&language=en-US&page=1")
      .then(function(respuesta) {
        return respuesta.json();
      })
      .then(function(datos) {
    ...
    fetch("https://api.themoviedb.org/3/movie/" + idTarde + "?api_key=cc55526ed6d9221ada36a41066b7c9ea&language=en-US")
      .then(function(response) {
        return response.json();
      })
    ...
    buscarRandom.innerHTML = '<a href="detalle.html?id=' + aleatorio() + '">' + 'Descubrir' + '</a>'
