window.addEventListener("load", function () {
  ...
  function vermas() {
    var url = "https://api.themoviedb.org/3/discover/tv?api_key=cc55526ed6d9221ada36a41066b7c9ea&language=en-US&sort_by=" + orden + "&first_air_date_year=" + año + "&page=" + page + "&timezone=America%2FNew_York&with_genres=" + incluir + "&without_genres=" + excluir + "&include_null_first_air_dates=false";
